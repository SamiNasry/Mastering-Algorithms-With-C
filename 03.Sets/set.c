...
int sert_insert(Set *set, const void *data)
{
...
int set_remove(Set *set, void **data)
{
	...
	for(member = list_hed(set); member != NULL; member = list_next(member))
	{
...
int set_union(Set *setu, const Set *set1, const Set *set2)
{
	...
	// Insert the memebrs of the second set
...
int set_intersection(Set *seti, const Set *set1, const Set *set2)
{
	...
	// Initilaize the set for the intersection 
...
int set_difference(Set *setd, const Set *set1, const Set *set2)
{
	...
	//Initiliaze the set for the difference.
